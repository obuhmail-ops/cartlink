      ...
      <section className="relative h-screen min-h-[900px] md:min-h-[760px] w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center pb-40 px-6 md:px-10 max-w-6xl mx-auto opacity-100">
          <div className="mt-64 self-center">
            <div className="rounded-full px-10 py-3 bg-brand/40 backdrop-blur-sm border border-solar/50 md:shadow-[0_0_30px_hsl(43_100%_50%/0.6),inset_0_0_20px_hsl(43_100%_50%/0.3)]">
              <p className="text-solar font-semibold tracking-[0.25em] uppercase text-center text-[42px] md:text-[42px] no-underline md:drop-shadow-[0_0_12px_hsl(43_100%_50%/0.8)]">
