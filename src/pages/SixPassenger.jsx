...
const FEATURES = [
  { icon: '👨‍👩‍👧‍👦', title: 'Seats Up to 6', body: 'Spacious seating for the whole family or group of friends.' },
  { icon: '🔋', title: 'Long-Range Lithium Battery', body: 'Up to 60 miles of range — built for a full Key West day.' },
  { icon: '🚗', title: 'Premium Electric Cart', body: 'Smooth, quiet electric ride with zero emissions.' },
...
const SEO_TITLE = '6-Passenger Golf Cart Rental Key West | Spacious Electric Cart for Groups';
const SEO_DESCRIPTION =
  'Rent a premium 6-passenger electric golf cart in Key West. Seats up to 6 with spacious seating, long-range lithium battery, Apple CarPlay, premium soundbar, and free delivery to your hotel, Airbnb, airport or cruise port. Book your 6-seater today.';

export default function SixPassenger() {
  useEffect(() => {
  ...
  const handleBook = () => trackEvent('check_availability_click', { location: 'six_passenger_page', ride_type: '6-passenger' });
        ...
        <section className="px-6 md:px-10 max-w-6xl mx-auto">
          <header className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-5 text-base md:text-lg text-brand/70 leading-relaxed">
              ...
              and groups exploring Key West together. Enjoy a long-range lithium battery, Apple CarPlay,
              a premium soundbar, and free delivery anywhere on the island.
            </p>
            <a
          ...
          <div className="mt-12 overflow-hidden rounded-2xl border border-brand/10 bg-card shadow-sm">
            <Image
              src={CART_IMAGE}
              alt="6-passenger spacious electric golf cart in Key West"
              fittingType="fill"
